<template>
  <div class="clearBox">
    ...
    <el-row class="table_row">
      ...
      >
        <el-table-column prop="alarmObject" label="告警对象"></el-table-column>
        ...
        <el-table-column prop="alarmTime" width="140" label="告警时间"></el-table-column>
...
export default {
  ...
  watch: {
    ...
    //       this.tableRowClassName(this.tableData);
    //     }
    //   },
    //   deep: true
    // }
